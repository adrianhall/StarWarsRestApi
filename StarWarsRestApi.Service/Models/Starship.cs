...
namespace StarWarsRestApi.Service.Models
{
    ...
    /// A star ship.
    /// </summary>
    public class Starship : VehicleBase, IEquatable<Starship>
    {
        /// <summary>
        ...
        public Starship(int starshipId, string name, string starshipClass, string model, string manufacturer, long? cost, double length,
            ...
            : base("starship", starshipId, name, model, manufacturer, cost, length, crew, passengers, speed, cargoCapacity, consumables)
        {
