...
namespace StarWarsRestApi.Service.Models
{
    ...
    public class Person : BaseModel, IEquatable<Person>
    {
        ...
        public Person(int personId, string name, int? height, int? mass, string hairColor, string skinColor, string eyeColor, int? birthYear, Gender gender) : base("person", personId)
        {
            Name = name;
            Height = height;
            Mass = mass;
